...
buildfile='colonial.zip'
mainfunction='index.js'
bucketname='colonial-history'
binaryloc='s3://colonial-history/binary/'

# toggle which lambda function is being updated - assume two versions for rollouts
#lambdaruntime='colonialSkillBlue'
lambdaruntime='colonialHistorySkill'
